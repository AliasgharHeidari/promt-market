...
type Prompt struct {
	...
	// Moderation
	// RejectionNote holds the reason written by an admin when a prompt is
	// rejected. Only meaningful when Status == "rejected". Shown to the
	// prompt's seller so they know what to fix before resubmitting.
